---
title: "NOPD Disaster DV Analysis"
format: html
editor: visual
---
...
An analysis of family violence calls to police shows they decreased significantly during hurricanes Harvey and Ida and lagged in the aftermath. The dearth of activity during the disaster dragged the rolling 7-day average of family violence calls received by New Orleans police down by about fifteen calls after Ida. That average didn’t recover for about two weeks after the disaster declaration expired.
```{r}
...
```
Hurricane Ida caused a decrease in calls to the New Orleans police department as well. During Ida, family violence calls for service to NOPD dropped to their lowest levels of 2021. During the period of Hurricane Ida, NOPD received 316 family violence calls, down from an average of around 400 in the five years before.  
```{r}
# Calls for service during Ida vs. same time period in other years 
